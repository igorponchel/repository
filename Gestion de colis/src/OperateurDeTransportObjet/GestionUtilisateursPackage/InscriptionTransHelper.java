...
public class InscriptionTransHelper
{
     ...
     */
    public static void insert(org.omg.CORBA.Any a, OperateurDeTransportObjet.GestionUtilisateursPackage.InscriptionTrans t)
    {
        a.insert_Streamable(new OperateurDeTransportObjet.GestionUtilisateursPackage.InscriptionTransHolder(t));
    }
     ...
     */
    public static OperateurDeTransportObjet.GestionUtilisateursPackage.InscriptionTrans extract(org.omg.CORBA.Any a)
    {
        ...
        if (HAS_OPENORB && a instanceof org.openorb.CORBA.Any) {
            ...
            try {
                ...
                if(s instanceof OperateurDeTransportObjet.GestionUtilisateursPackage.InscriptionTransHolder)
                    return ((OperateurDeTransportObjet.GestionUtilisateursPackage.InscriptionTransHolder)s).value;
            } catch (org.omg.CORBA.BAD_INV_ORDER ex) {
            }
            OperateurDeTransportObjet.GestionUtilisateursPackage.InscriptionTransHolder h = new OperateurDeTransportObjet.GestionUtilisateursPackage.InscriptionTransHolder(read(a.create_input_stream()));
    ...
    private final static String _id = "IDL:OperateurDeTransportObjet/GestionUtilisateurs/InscriptionTrans:1.0";
     ...
     */
    public static OperateurDeTransportObjet.GestionUtilisateursPackage.InscriptionTrans read(org.omg.CORBA.portable.InputStream istream)
    {
